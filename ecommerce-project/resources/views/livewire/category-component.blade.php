    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Product Catrgories</span></li>
                ...
                <div class="wrap-shop-control">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model.live="pagessize">
       ...
       <nav aria-label="Page navigation">
        <ul class="pagination">
         <li class="page-item {{ $products->currentPage() == 1 ? ' disabled' : '' }}">
          <a class="page-link" href="{{ $products->previousPageUrl() }}" wire:click="previousPage">
                        ...
                        <ul class="list-category">
                            @foreach ($categories as $category)
                                <li class="category-item">
                                    <a href="/product-category/{{$category->slug}}" class="cate-link">{{$category->name}}</a>
                                </li>
                            @endforeach
