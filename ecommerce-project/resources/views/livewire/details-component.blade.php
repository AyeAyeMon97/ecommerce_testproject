									...
									<li class="product-item">
										<div class="product product-widget-style">
											<div class="thumbnnail">
												<a href="/product/{{$product->id}}" title="{{$p_product->name}}">
													<figure><img src="{{asset('assets/images/products')}}/{{$p_product->image}}" alt=""></figure>
												</a>
											</div>
											<div class="product-info">
												<a href="/product/{{$product->id}}" class="{{$p_product->name}}"><span>{{$p_product->name}}</span></a>
								...
								@foreach($related_products as $r_product)
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="/product/{{$product->id}}" title="{{$r_product->name}}">
											...
											<div class="wrap-btn">
												<a href="/product/{{$product->id}}" class="function-link">quick view</a>
											</div>
										</div>
										<div class="product-info">
											<a href="/product/{{$product->id}}" class="product-name"><span>{{$r_product->name}}</span></a>
